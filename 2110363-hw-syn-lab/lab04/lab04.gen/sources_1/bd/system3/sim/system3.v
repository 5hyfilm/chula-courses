...
module system3
  ...
  system3_calculator_0_0 calculator_0
       (.a(swA_1),
        ...
        .sub(btnD_1));
  system3_clkDivide_0_0 clkDivide_0
       (.bit(xlconstant_0_dout),
        .clk(clk_1),
        .fClk(clkDivide_0_fClk));
  system3_segmentDriver_0_0 segmentDriver_0
       (.an(segmentDriver_0_an),
        .fClk(clk_1),
        .hex(calculator_0_out),
        .seg(segmentDriver_0_seg));
  system3_xlconstant_0_0 xlconstant_0
