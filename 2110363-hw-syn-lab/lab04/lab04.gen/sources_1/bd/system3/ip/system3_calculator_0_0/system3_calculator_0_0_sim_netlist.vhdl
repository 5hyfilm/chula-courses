...
-- Date        : Tue Sep 17 14:42:11 2024
-- Host        : Oar-Stu0829 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/OarChula/Documents/GitHub/2110363-HWSynLab/lab04/lab04.gen/sources_1/bd/system3/ip/system3_calculator_0_0/system3_calculator_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of system3_calculator_0_0_flipflop_28 is
  ...
  attribute SOFT_HLUTNM of \sum[0]_i_16\ : label is "soft_lutpair5";
...
\sum[0]_i_16\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30000800"
    )
        port map (
...
architecture STRUCTURE of system3_calculator_0_0_flipflop_3 is
  ...
  signal \sum[0]_i_19_n_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \i___1_carry_i_8__0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \sum[0]_i_19\ : label is "soft_lutpair2";
begin
  p_1_in(0) <= \^p_1_in\(0);
...
\sum[0]_i_19\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"080F"
    )
        port map (
...
\sum[0]_i_25\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
architecture STRUCTURE of system3_calculator_0_0_flipflop_31 is
  signal \^st_reg_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \sum[0]_i_23\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \sum[3]_i_6\ : label is "soft_lutpair6";
begin
  st_reg_0 <= \^st_reg_0\;
...
\sum[2]_i_10\: unisim.vcomponents.LUT6
    generic map(
...
entity system3_calculator_0_0_flipflop_34 is
  port (
    ...
    \sum_reg[4]\ : in STD_LOGIC;
    \sum_reg[4]_0\ : in STD_LOGIC;
    \sum_reg[4]_1\ : in STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of system3_calculator_0_0_flipflop_34 is
  ...
  attribute SOFT_HLUTNM of \sum[2]_i_6\ : label is "soft_lutpair7";
begin
  DI(0) <= \^di\(0);
  st_reg_0 <= \^st_reg_0\;
...
\sum[2]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\sum[0]_i_12\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
entity system3_calculator_0_0_flipflop_40 is
  port (
    ...
    st_reg_4 : out STD_LOGIC;
    S : out STD_LOGIC_VECTOR ( 0 to 0 );
    st_reg_5 : out STD_LOGIC_VECTOR ( 0 to 0 );
    DI : out STD_LOGIC_VECTOR ( 0 to 0 );
    st_reg_6 : in STD_LOGIC;
    clk : in STD_LOGIC;
    \sum_reg[11]\ : in STD_LOGIC;
    \sum_reg[4]\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
    \sum_reg[11]_0\ : in STD_LOGIC;
    ...
    \sum_reg[4]_0\ : in STD_LOGIC;
    \sum[2]_i_4_0\ : in STD_LOGIC;
    \sum[2]_i_4_1\ : in STD_LOGIC;
    \sum0_inferred__2/i___1_carry__0\ : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
...
architecture STRUCTURE of system3_calculator_0_0_flipflop_40 is
  ...
  signal \sum[2]_i_12_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \sum[0]_i_24\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \sum[2]_i_12\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \sum[2]_i_5\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \sum[2]_i_7\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \sum[2]_i_9\ : label is "soft_lutpair9";
...
\sum[2]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B0FB"
    )
        port map (
...
\sum[2]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\sum[2]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"40F4"
    )
        port map (
...
\sum[3]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of system3_calculator_0_0_flipflop_6 is
  ...
  signal \sum[0]_i_14_n_0\ : STD_LOGIC;
  signal \sum[0]_i_17_n_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \i___1_carry_i_9\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \sum[2]_i_11\ : label is "soft_lutpair3";
begin
...
\sum[2]_i_11\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
entity system3_calculator_0_0_singlePulse is
  port (
    ...
    d_reg_4 : out STD_LOGIC;
    \btn[3]_0\ : in STD_LOGIC;
    clk : in STD_LOGIC;
    d_reg_5 : in STD_LOGIC;
    \sum_reg[1]\ : in STD_LOGIC;
    ...
    \sum_reg[1]_5\ : in STD_LOGIC;
    \sum_reg[0]_4\ : in STD_LOGIC;
    \sum_reg[0]_5\ : in STD_LOGIC;
    \sum_reg[0]_6\ : in STD_LOGIC;
    \sum_reg[0]_7\ : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
...
architecture STRUCTURE of system3_calculator_0_0_singlePulse is
  ...
  signal \^d_reg_3\ : STD_LOGIC;
  signal \sum[0]_i_21_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \sum[0]_i_13\ : label is "soft_lutpair1";
...
\sum[0]_i_13\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\sum[0]_i_15\: unisim.vcomponents.LUT6
    generic map(
...
\sum[0]_i_20\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\sum[0]_i_21\: unisim.vcomponents.LUT6
    generic map(
...
\sum[0]_i_18\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of system3_calculator_0_0_calculator is
  ...
  signal \genblk1[0].sp_n_1\ : STD_LOGIC;
  ...
  signal \genblk1[0].sp_n_9\ : STD_LOGIC;
  ...
  signal \genblk1[2].sp_n_0\ : STD_LOGIC;
  ...
  signal \genblk1[3].sp_n_0\ : STD_LOGIC;
  ...
  signal \genblk1[4].sp_n_0\ : STD_LOGIC;
  ...
  signal \genblk1[7].ff1_n_7\ : STD_LOGIC;
  ...
  signal \out1_inferred__0/i___29_carry__0_n_0\ : STD_LOGIC;
  signal \out1_inferred__0/i___29_carry__0_n_1\ : STD_LOGIC;
  signal \out1_inferred__0/i___29_carry__0_n_2\ : STD_LOGIC;
  signal \out1_inferred__0/i___29_carry__0_n_3\ : STD_LOGIC;
  signal \out1_inferred__0/i___29_carry__1_n_3\ : STD_LOGIC;
  signal \out1_inferred__0/i___29_carry_n_0\ : STD_LOGIC;
  signal \out1_inferred__0/i___29_carry_n_1\ : STD_LOGIC;
  signal \out1_inferred__0/i___29_carry_n_2\ : STD_LOGIC;
  signal \out1_inferred__0/i___29_carry_n_3\ : STD_LOGIC;
  ...
  signal \NLW_out1_inferred__0/i___29_carry_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_out1_inferred__0/i___29_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_out1_inferred__0/i___29_carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_out1_inferred__0/i___29_carry__1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ADDER_THRESHOLD of \out1_inferred__0/i___29_carry\ : label is 35;
  attribute ADDER_THRESHOLD of \out1_inferred__0/i___29_carry__0\ : label is 35;
  attribute ADDER_THRESHOLD of \out1_inferred__0/i___29_carry__1\ : label is 35;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \out[10]_INST_0\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \out[1]_INST_0_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \out[4]_INST_0_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \out[4]_INST_0_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \out[8]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \out[9]_INST_0\ : label is "soft_lutpair12";
begin
...
\genblk1[0].sp\: entity work.system3_calculator_0_0_singlePulse
     port map (
      D(1) => \genblk1[0].sp_n_2\,
      D(0) => \genblk1[0].sp_n_3\,
      E(0) => \genblk1[0].sp_n_7\,
...
\genblk1[7].ff1\: entity work.system3_calculator_0_0_flipflop_34
     port map (
      D(0) => \genblk1[7].ff1_n_3\,
      DI(0) => \genblk1[7].ff1_n_1\,
      O(0) => sum0(4),
      S(0) => \genblk1[7].ff1_n_6\,
      clk => clk,
      p_1_in(3 downto 0) => p_1_in(3 downto 0),
      ...
      \sum_reg[4]_1\(0) => \genblk1[8].ff1_n_1\
    );
...
\genblk1[9].ff1\: entity work.system3_calculator_0_0_flipflop_40
     port map (
      ...
      \sum_reg[4]\(2 downto 0) => p_1_in(3 downto 1),
...
\i___29_carry_i_1__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\i___29_carry_i_1__1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\i___29_carry_i_2__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\i___29_carry_i_2__1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\i___29_carry_i_3__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\i___29_carry_i_4__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\i___29_carry_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"D22D"
    )
        port map (
...
\i___29_carry_i_5__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1E"
    )
        port map (
...
\i___29_carry_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4BB4"
    )
        port map (
...
\i___29_carry_i_6__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"C9"
    )
        port map (
...
\i___29_carry_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B44B"
    )
        port map (
...
\i___29_carry_i_7__0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B44B"
    )
        port map (
...
\i___29_carry_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2DD2"
    )
        port map (
...
\i___29_carry_i_8__0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2DD2"
    )
        port map (
...
\out1_inferred__0/i___29_carry\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \out1_inferred__0/i___29_carry_n_0\,
      CO(2) => \out1_inferred__0/i___29_carry_n_1\,
      CO(1) => \out1_inferred__0/i___29_carry_n_2\,
      CO(0) => \out1_inferred__0/i___29_carry_n_3\,
      CYINIT => '0',
      DI(3) => \i___29_carry_i_1_n_0\,
      DI(2) => \i___29_carry_i_2_n_0\,
      DI(1) => \i___29_carry_i_3__0_n_0\,
      DI(0) => \i___29_carry_i_4_n_0\,
      O(3 downto 0) => \NLW_out1_inferred__0/i___29_carry_O_UNCONNECTED\(3 downto 0),
      S(3) => \i___29_carry_i_5_n_0\,
      S(2) => \i___29_carry_i_6_n_0\,
      S(1) => \i___29_carry_i_7_n_0\,
      S(0) => \i___29_carry_i_8_n_0\
    );
\out1_inferred__0/i___29_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => \out1_inferred__0/i___29_carry_n_0\,
      CO(3) => \out1_inferred__0/i___29_carry__0_n_0\,
      CO(2) => \out1_inferred__0/i___29_carry__0_n_1\,
      CO(1) => \out1_inferred__0/i___29_carry__0_n_2\,
      CO(0) => \out1_inferred__0/i___29_carry__0_n_3\,
      CYINIT => '0',
      DI(3) => \i___29_carry_i_1__0_n_0\,
      DI(2) => \i___29_carry_i_2__0_n_0\,
      DI(1) => \i___29_carry_i_3_n_0\,
      DI(0) => \i___29_carry_i_4__0_n_0\,
      O(3 downto 0) => \NLW_out1_inferred__0/i___29_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => \i___29_carry_i_5__0_n_0\,
      S(2) => \i___29_carry_i_6__0_n_0\,
      S(1) => \i___29_carry_i_7__0_n_0\,
      S(0) => \i___29_carry_i_8__0_n_0\
    );
\out1_inferred__0/i___29_carry__1\: unisim.vcomponents.CARRY4
     port map (
      CI => \out1_inferred__0/i___29_carry__0_n_0\,
      CO(3 downto 1) => \NLW_out1_inferred__0/i___29_carry__1_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \out1_inferred__0/i___29_carry__1_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \i___29_carry_i_1__1_n_0\,
      O(3 downto 0) => \NLW_out1_inferred__0/i___29_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3 downto 1) => B"000",
      S(0) => \i___29_carry_i_2__1_n_0\
    );
...
entity system3_calculator_0_0 is
  ...
  attribute X_CORE_INFO of system3_calculator_0_0 : entity is "calculator,Vivado 2024.1";
