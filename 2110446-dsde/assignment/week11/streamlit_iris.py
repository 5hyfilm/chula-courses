...
max_clusters = st.sidebar.slider('Select Number of Clusters:', 
                                 min_value=1, 
                                 max_value=10, 
                                 value=3)
...
fig_scatter = px.scatter_matrix(df, dimensions=feature_names, 
                                color='Species', 
                                color_discrete_map=colors)
...
inertias = perform_elbow_analysis(X_scaled, max_clusters=max_clusters)
...
with col1:
    ...
    fig_col1 = px.scatter(df, 
                          x='petal length (cm)',       
                          y='petal width (cm)',
                          color='Cluster',
                          color_discrete_map={'0': '#005da6', '1': '#80bfed', '2': '#FF4B4B'},
